...
async function fetchRentals() {
  try {
    ...
    const firstPageUrl = `${BASE_URL}/v1/projects?page=1&limit=${LIMIT}`;
    ...
    for (let page = 2; page <= totalPages; page++) {
      ...
      const pageUrl = `${BASE_URL}/v1/projects?page=${page}&limit=${LIMIT}`;
    ...
    fs.writeFileSync('projects.json', JSON.stringify(allRentals, null, 2));
